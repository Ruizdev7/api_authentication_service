      ...
      <div className="bg-white container mx-auto p-2">
        <div className="flex flex-col mx-auto gap-4 lg:w-[950px]">
          ...
          <p className="text-[14px]mb-5">
            El sistema por defecto cuenta con el registro de cada uno de los
            módulos del sistema, por ende, solo deberá seleccionar el rol que
            desea configurar y el tipo de permisos para cada uno de los módulos
            de la aplicación.
          </p>
          <RBAC />
        </div>
