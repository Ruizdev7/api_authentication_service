...
import logo_oficial_plena_blanco from "./../assets/images/logo_oficial.jpg";
...
const SideBar = () => {
  ...
  const [showMenuDemographicData, setShowMenuDemographicData] = useState(false);
    ...
    <>
      ...
      >
        <div>
          ...
          <ul>
            <li>
              ...
              <ul className={`my-2 ${!showMenuDashBoard && "hidden"}`}>
                <li>
                  <Link
                    to="/metrics/hhrr"
            ...
            <li>
              ...
              <ul className={`my-2 ml-[15px] ${!showMenuSettings && "hidden"}`}>
                <button
                  onClick={() =>
                    setShowMenuDefiniteCodes(!showMenuDefiniteCodes)
                  }
                ...
                >
                  ...
                  >
                    Datos Personales
                    <RiArrowRightSLine
                      className={`mt-1 mx-5 ${showPersonalInformation && "rotate-90"
                        } transition-all`}
                    />
                  </button>
                  <ul
                ...
                >
                  <button
                    onClick={() => setShowAfiliationData(!ShowAfiliationData)}
                    className="text-white  text-sm flex items-center hover:text-sky-600 hover:font-bold py-2 px-4 border-l border-gray-500 ml-6 block relative before:w-3 before:h-3 before:absolute before:bg-sky-900 before:rounded-full before:-left-[6.5px] before:top-1/2 before:-translate-y-1/2 before:border-4 before:border-secondary-100 transition-colors"
                  >
                    Datos de Afiliacion
                    <RiArrowRightSLine
                      className={`mt-1 mx-5 ${ShowAfiliationData && "rotate-90"
                        } transition-all`}
                    />
                  </button>
                  <ul className={`my-2 ${!ShowAfiliationData && "hidden"}`}>
                    <li className="ml-[15px]">
                      <Link
                ...
                >
                  <button
                    onClick={() =>
                      setShowMenuRelationship(!showMenuRelationship)
                    }
                    className="text-white  text-sm flex items-center hover:text-sky-600 hover:font-bold py-2 px-4 border-l border-gray-500 ml-6 block relative before:w-3 before:h-3 before:absolute before:bg-sky-900 before:rounded-full before:-left-[6.5px] before:top-1/2 before:-translate-y-1/2 before:border-4 before:border-secondary-100 transition-colors"
                  >
                    Datos de Vinculacion Laboral
                    <RiArrowRightSLine
                      className={`mt-1 mx-5 ${showMenuRelationship && "rotate-90"
                        } transition-all`}
                    />
                  </button>
                  <ul className={`my-2 ${!showMenuRelationship && "hidden"}`}>
                    <li className="ml-[15px]">
                      <Link
                ...
                >
                  <button
                    onClick={() =>
                      setShowMenuDemographicData(!showMenuDemographicData)
                    }
                    className="text-white  text-sm flex items-center hover:text-sky-600 hover:font-bold py-2 px-4 border-l border-gray-500 ml-6 block relative before:w-3 before:h-3 before:absolute before:bg-sky-900 before:rounded-full before:-left-[6.5px] before:top-1/2 before:-translate-y-1/2 before:border-4 before:border-secondary-100 transition-colors"
                  >
                    Datos Demograficos
                    <RiArrowRightSLine
                      className={`mt-1 mx-5 ${showMenuDemographicData && "rotate-90"
                        } transition-all`}
                    />
                  </button>
                  <ul
                ...
                >
                  ...
                  >
                    Datos Sociodemograficos
                    <RiArrowRightSLine
                      className={`mt-1 mx-5 ${ShowMenuSocioDemographicData && "rotate-90"
                        } transition-all`}
                    />
                  </button>
                  <ul
                    className={`my-2 ${!ShowMenuSocioDemographicData && "hidden"
                      }`}
                  >
                    <li className="ml-[15px]">
                      <Link
        ...
        <button
          ...
          className="fixed bottom-4 right-4 bg-sky-900 text-white p-3 rounded-full z-50"
        >
