...
export const authSlice = createSlice({
  ...
  reducers: {
    setCredentials: (state, action) => {
      state.current_user.ccn_employee =
        action.payload.current_user.ccn_employee;
      state.current_user.token = action.payload.current_user.token;
      state.current_user.full_name_employee =
        action.payload.current_user.full_name_employee;
      state.current_user.informed_consent_law_1581 =
        action.payload.current_user.informed_consent_law_1581;
      state.access_level.Type_Relationship =
        action.payload.access_level.Type_Relationship;
...
export const { setCredentials, cleanCredentials, setInformedConsentLaw1581 } =
  authSlice.actions;
